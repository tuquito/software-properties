...
from PyKDE4.kdecore import ki18n, i18n, KUrl
from PyKDE4.kdeui import KApplication, KMessageBox, KIcon, KWindowSystem
...
class SoftwarePropertiesKDE(SoftwareProperties):
  ...
  def init_release_upgrades(self):
    ...
    kapp.connect(self.userinterface.combobox_release_upgrades, SIGNAL("currentIndexChanged(int)"), self.on_combobox_release_upgrades_changed)
